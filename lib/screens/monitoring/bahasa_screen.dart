                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      color: AppColors.catBahasa.withValues(alpha: 0.12),
                      borderRadius: BorderRadius.circular(16),
                    ),
                    child: Row(
                      children: [
                        const Icon(Icons.child_care_rounded, color: AppColors.catBahasa, size: 22),
                  ...
                  Text(
                    'Kemampuan berkomunikasi dan memahami bahasa',
