...
class KognitifScreen extends StatefulWidget {
  const KognitifScreen({super.key});
  @override
  State<KognitifScreen> createState() => _KognitifScreenState();
}

class _KognitifScreenState extends State<KognitifScreen> {
  ...
  Future<void> _loadData() async {
    ...
    _milestones = await _db.getMilestones('kognitif', _child!.ageInMonths);
